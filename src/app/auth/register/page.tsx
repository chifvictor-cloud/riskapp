    ...
    return (
      <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <Link
            href="/auth/login"
            className="inline-block bg-[#e85d24] hover:bg-[#d14d18] text-white font-bold px-6 py-3 rounded-xl transition-colors"
          >
            Ir a iniciar sesión
          </Link>
        </div>
    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4 py-12">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-[#111] border border-[#222] rounded-2xl p-8">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#e85d24] hover:bg-[#d14d18] disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold py-3 rounded-xl transition-colors mt-2"
            >
        ...
        <p className="text-center text-[#888] mt-6">
          ¿Ya tienes cuenta?{' '}
          <Link href="/auth/login" className="text-[#e85d24] font-semibold hover:underline">
            Iniciar sesión
          </Link>
        </p>
      </div>
